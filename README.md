...
Affinché la connessione funzioni correttamente, i computer dei giocatori devono essere collegati tra loro tramite una rete

Se invece si desidera giocare in locale, è possibile avviare il server e poi eseguire tre istanze del client sullo stesso dispositivo (in locale), simulando così una partita tra tre giocatori.
