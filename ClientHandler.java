...
public class ClientHandler implements Runnable {
 ...
 // Senza "volatile" ogni thread potrebbe avere una copia vecchia del valore
 // nella sua cache, e non accorgersi delle modifiche dell'altro thread.
 // con volatile si garantisce che le letture e le scritture avvengano
 // sempre sulla memoria principale, quindi entrambi i thread vedono
 // sempre il valore aggiornato.
    private volatile String  ultimoMessaggio= null;
    private volatile boolean messaggioDisponibile = false;
